...
与“$@”类似的还有：$#,$\*,$0,$1...$4
$#:表示传递给参数的个数
$\*与$@的区别在于，前者是将所有参数用一对引号引起来，而$@是将每一个参数分别用引号引起来。$0表示脚本的名字，$1,$2...表示脚本的第一个参数，第二个参数，以此类推。
想要了解更多，可[参考](http://www.cnblogs.com/kaituorensheng/p/4002697.html)

因此，虽然我们之前运行的是`hadoop`命令，但实际上，我们运行的是命令`/usr/hdp/2.5.0.0-1245//hadoop/bin/hadoop.distro`
